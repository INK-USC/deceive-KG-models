...
def main():
    ...
    parser.add_argument('--delayed_reward_step',default=50000, type=int, help='Batch size for updates from the replay buffer.')
    ...
    #  save_paths, log_path
    parser.add_argument('--save_dir', default=f'./saved_models/KG/test', help='model output directory')
    ...
    parser.add_argument('--cpnet_index', default='./new_vocab_movie.txt')
    ...
    parser.add_argument('--cpt_emb', default='node_embs.npy')
    parser.add_argument('--relation_emb', default='rel_embs.npy')
...
def train(args):
    ...
    kg_np = np.load("../data/" + args.dataset + "/kg_initial.npy")
    graph = npy2nx(kg_np, "../data/cpnet/conceptnet_2.en.pruned.graph")
    ...
    if args.debug_mode:
        ...
        kg_np = nx2npy(graph, '../data/' + args.dataset + '/kg_final.npy')
        dev_auc = main2()
        init_avg_prob = dev_auc
