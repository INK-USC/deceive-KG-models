...
def main():
    ...
    parser.add_argument('--graph_model', default=2, type=int, help='model id=0:RN,  1:GN')
    ...
    parser.add_argument('--num_steps',default=70001, type=int, help='total num of steps per epoch')
