...
def main1():
    ...
    routines = {
        ...
        'csqa': [
            ...
            #                          output_paths['cpnet']['patterns'], output_paths['csqa']['grounded']['train'], 56)},
            #{'func': ground, 'args': (output_paths['csqa']['statement']['dev'], output_paths['cpnet']['vocab'],
            #                          output_paths['cpnet']['patterns'], output_paths['csqa']['grounded']['dev'], 56)},
            ...
            {'func': find_paths, 'args': (output_paths['csqa']['grounded']['train'], output_paths['cpnet']['vocab'],
                                          output_paths['cpnet']['pruned-graph'], output_paths['csqa']['paths']['raw-train'], 56, args.seed)},
            {'func': find_paths, 'args': (output_paths['csqa']['grounded']['dev'], output_paths['cpnet']['vocab'],
                                          output_paths['cpnet']['pruned-graph'], output_paths['csqa']['paths']['raw-dev'], 56, args.seed)},
            ...
            {'func': score_paths, 'args': (output_paths['csqa']['paths']['raw-train'], input_paths['transe']['ent'], input_paths['transe']['rel'],
                                           output_paths['cpnet']['vocab'], output_paths['csqa']['paths']['scores-train'], 56)},
            {'func': score_paths, 'args': (output_paths['csqa']['paths']['raw-dev'], input_paths['transe']['ent'], input_paths['transe']['rel'],
                                           output_paths['cpnet']['vocab'], output_paths['csqa']['paths']['scores-dev'], 56)},
            ...
            #                                                            output_paths['cpnet']['vocab'], output_paths['csqa']['graph']['adj-train'], 56)},
            #{'func': generate_adj_data_from_grounded_concepts, 'args': (output_paths['csqa']['grounded']['dev'], output_paths['cpnet']['pruned-graph'],
            #                                                            output_paths['cpnet']['vocab'], output_paths['csqa']['graph']['adj-dev'], 56)},
            ...
            #{'func': generate_path_and_graph_from_adj, 'args': (output_paths['csqa']['graph']['adj-train'], output_paths['cpnet']['pruned-graph'], output_paths['csqa']['paths']['adj-train'], output_paths['csqa']['graph']['nxg-from-adj-train'], 50)},
            #{'func': generate_path_and_graph_from_adj, 'args': (output_paths['csqa']['graph']['adj-dev'], output_paths['cpnet']['pruned-graph'], output_paths['csqa']['paths']['adj-dev'], output_paths['csqa']['graph']['nxg-from-adj-dev'], 50)},
    ...
    #perturb_cpnet('./data/cpnet/conceptnet_2.en.pruned.graph', 70000, './data/cpnet/conceptnet.en.pruned.graph')
    for rt in args.run:
