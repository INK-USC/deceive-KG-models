...
def main1():
    ...
    routines = {
        'common': [
            ...
            #{'func': construct_graph, 'args': (output_paths['cpnet']['csv'], output_paths['cpnet']['vocab'],
            #                                   output_paths['cpnet']['pruned-graph'], 0, True)},
        ...
        'csqa': [
            ...
            #                          output_paths['cpnet']['patterns'], output_paths['csqa']['grounded']['train'], 50)},
            #{'func': ground, 'args': (output_paths['csqa']['statement']['dev'], output_paths['cpnet']['vocab'],
            #                          output_paths['cpnet']['patterns'], output_paths['csqa']['grounded']['dev'], 50)},
            ...
            {'func': find_paths, 'args': (output_paths['csqa']['grounded']['dev'], output_paths['cpnet']['vocab'],
                                          output_paths['cpnet']['pruned-graph'], output_paths['csqa']['paths']['raw-dev'], 50, args.seed)},
            ...
            {'func': score_paths, 'args': (output_paths['csqa']['paths']['raw-dev'], input_paths['transe']['ent'], input_paths['transe']['rel'],
                                           output_paths['cpnet']['vocab'], output_paths['csqa']['paths']['scores-dev'], 50)},
