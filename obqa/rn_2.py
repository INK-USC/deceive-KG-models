...
def main2(mode = 'train', model=None):
    ...
    find_relational_paths(args.cpnet_vocab_path, args.cpnet_graph_path, args.train_concepts, args.train_rel_paths, args.nprocs, False)
    find_relational_paths(args.cpnet_vocab_path, args.cpnet_graph_path, args.dev_concepts, args.dev_rel_paths, args.nprocs, False)
    if args.test_statements is not None:
        find_relational_paths(args.cpnet_vocab_path, args.cpnet_graph_path, args.test_concepts, args.test_rel_paths, args.nprocs, False)

    if mode == 'train':
        train(args)
    elif mode == 'eval':
       return(eval(args, model))
...
def train(args):
    ...
    dataset = LMRelationNetDataLoader( train_statement_path = args.train_statements, train_rpath_jsonl = args.train_rel_paths,
